...
class SpeedRecognizer:
    def __init__(self,
                 speed_rects_xys=([0.8717, 0.8965],[0.8870, 0.8965],[0.9036, 0.8965]),
                 speed_rect_size=(0.0130, 0.0360),
                 img_size=(1280, 800),
                 thres=210):
        '''
        1280 * 720:
    ...
    def get_speed(self, img, index=None):
        ...
        for i, rect in enumerate(self.speed_rects_xys):
            ...
            if self.debug:
                cv2.imwrite('im_debug_signals_{}_{}.jpg'.format(index, i), single_num_img)
